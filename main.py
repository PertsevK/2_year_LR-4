...
def main():
    ...
    # та створюємо екземпляри класу Point_5
    ...
    for i in range(3):
        try:
            ...
            tmp_point = Point_5(tmp_x, tmp_y)
            print(Point_5.get_count())
...
def task15(list_of3_points):
    """Створити список з трьох точок, порахувати відстань між першою і
    третьою, пересунути другу на 45 вгору."""
